    ...
    <main id="content">
        <div id="login">
            ...
            <form action="signup" method="post">
            	<div class="form-row">
                    <label for="id_name" class="required" title="Preenchimento obrigatório">Nome:</label>
                    <input required type="text" name="name" autofocus="" autocapitalize="none" autocomplete="name" maxlength="150" id="id_name">
                </div>
